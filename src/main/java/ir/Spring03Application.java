...
public class Spring03Application {
    ...
    public Spring03Application(RoleService roleService, UserService userService, TicketService ticketService, MessageService messageService) {
        Spring03Application.roleService = roleService;
        Spring03Application.userService = userService;
        Spring03Application.ticketService = ticketService;
        Spring03Application.messageService = messageService;
    }
